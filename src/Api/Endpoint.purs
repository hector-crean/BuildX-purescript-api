-- | BuildX uses a REST API for resource management. This module defines endpoints in a data type
...
-- |
-- | This module takes the same approach as the `BuildX.Data.Route` module. For a more in-depth
...
module BuildX.Api.Endpoint where
...
import BuildX.Data.Comment (CommentId)
import BuildX.Data.Route (slug, uname)
