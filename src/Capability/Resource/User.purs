...
-- | any application code besides the application monad, `BuildX.AppM`. In addition, we can test
...
module BuildX.Capability.Resource.User where

import Prelude

import BuildX.Api.Request (LoginFields, RegisterFields)
import BuildX.Data.Email (Email)
import BuildX.Data.Profile (Profile, ProfileRep, ProfileWithEmail, Author)
...
-- | `BuildX.Data.Profile` module for more details.
