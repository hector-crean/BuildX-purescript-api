...
-- |
-- | See the various `BuildX.Capability.*` modules for deeper explanations of each capability, and
...
module BuildX.AppM where

import Prelude

import BuildX.Api.Endpoint (Endpoint(..), noArticleParams)
import BuildX.Api.Request (RequestMethod(..))
import BuildX.Api.Request as Request
import BuildX.Api.Utils (authenticate, decode, decodeWithUser, mkAuthRequest, mkRequest)
import BuildX.Capability.LogMessages (class LogMessages)
import BuildX.Capability.Navigate (class Navigate, navigate)
import BuildX.Capability.Now (class Now)
import BuildX.Capability.Resource.Article (class ManageArticle)
import BuildX.Capability.Resource.Comment (class ManageComment)
import BuildX.Capability.Resource.Tag (class ManageTag)
import BuildX.Capability.Resource.User (class ManageUser)
import BuildX.Data.Article as Article
import BuildX.Data.Comment as Comment
import BuildX.Data.Log as Log
import BuildX.Data.Profile as Profile
import BuildX.Data.Route as Route
import BuildX.Env (Env, LogLevel(..))
...
-- | In the capability modules (`BuildX.Capability.*`), we wrote some abstract, high-level
